...
class PrivilegesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Privilege::create(['name' => 'Comité Campo "Buena Vista"', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
        Privilege::create(['name' => 'Comité Campo Evangelístico "El Chuluc"', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
        Privilege::create(['name' => 'Comité Campo Evangelístico Pahuit', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
        Privilege::create(['name' => 'Comité Campo Evangelístico Zona 3', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
        Privilege::create(['name' => 'Comité Campo Evangelístico Zona 4 "A"', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
        Privilege::create(['name' => 'Comité Campo Evangelístico Zona 4 "B"', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
        Privilege::create(['name' => 'Comité Campo "La Esperanza"', 'preferred_sex' => 'M', 'preferred_status' => 1, 'min_age' => 18]);
