<div class="row" id="edit-privilege" data-id="{{ $the_privilege->id }}">
  <div class="form-group col-sm-12 col-md-12 col-lg-6">
    <label for="privilege_select_edit">{{ __('Nombre del privilegio') }}<span class="text-danger">*</span></label>
    <select name="privilege_select_edit" id="privilege_select_edit" class="form-control selectpicker show-tick" data-live-search="true" required>
  ...
  <div class="form-group col-sm-6 col-md-6 col-lg-3">
    ...
    <input type="date"
      name="privilege_start_edit"
      id="privilege_start_edit"
      class="form-control @error('privilege_start_edit') is-invalid @enderror"
      value="{{ old('privilege_start_edit') ?? $the_privilege->start_date }}"
    >

    @error('privilege_start_edit')
  ...
  <div class="form-group col-sm-6 col-md-6 col-lg-3">
    ...
    <input type="date"
      name="privilege_end_edit"
      id="privilege_end_edit"
      class="form-control @error('privilege_end_edit') is-invalid @enderror"
      value="{{ old('privilege_start_edit') ?? $the_privilege->end_date}}"
    >

    @error('privilege_end_edit')
      <span class="invalid-feedback" role="alert">
        <strong>{{ $message }}</strong>
      </span>
    @enderror
  ...
  <div class="form-group col-sm-12 col-md-12 col-lg-6">
    ...
    <select name="privilege_role_id_edit" id="privilege_role_id_edit" class="form-control selectpicker show-tick" data-live-search="true">
