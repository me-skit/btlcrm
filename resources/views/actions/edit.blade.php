        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ route('action.update', $action->id) }}" method="POST">
              ...
              <div class="row form-group">
                <label for="path" class="col-md-4 col-form-label text-md-right">{{ __('Dirección') }}</label>
                <div class="col-md-6">
                  <input type="text"
                    name="path"
                    id="path"
              ...
              <div class="row form-group">
                <label for="icon" class="col-md-4 col-form-label text-md-right">{{ __('Longitud') }}</label>
                <div class="col-md-6">
                  <input type="text"
                    name="icon"
                    id="icon"
