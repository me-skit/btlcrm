...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header font-weight-bold"><i class="fas fa-user-cog"></i> {{ __('Registrar Usuario') }}</div>
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('user.update', $user->id) }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                  <input id="nickname" type="text" class="form-control @error('nickname') is-invalid @enderror" name="nickname" value="{{ old('nickname') ?? $user->nickname }}" autocomplete="nickname">
